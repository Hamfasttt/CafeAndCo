...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 21 mai 2021 à 14:48
...
INSERT INTO `commande` (`id_comm`, `num_comm`) VALUES
(1, 1);
...
(1, 'Identifier les Arômes ', '00:20:00', NULL),
(2, 'Vendre le Café', '01:00:00', NULL),
(3, 'Manager son équipe', '02:30:00', NULL);
...
--
ALTER TABLE `elearning`
  MODIFY `id_learn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
